package de.hsh.project.bomberman.game.board;

import de.hsh.project.bomberman.game.player.Player;
import de.hsh.project.bomberman.game.tile.Tile;
...
public abstract class GameBoard {
    ...
    public GameBoard(Player[] player) {
        ...
        this.staticBuffer = new BufferedImage(GRID_WIDTH * Tile.TILE_SIZE, GRID_HEIGHT * Tile.TILE_SIZE, BufferedImage.TYPE_INT_ARGB);
        this.dynamicBuffer = new BufferedImage(GRID_WIDTH * Tile.TILE_SIZE, GRID_HEIGHT * Tile.TILE_SIZE, BufferedImage.TYPE_INT_ARGB);
        ...
        addStaticRect(0, 0, GRID_WIDTH * Tile.TILE_SIZE, Tile.TILE_SIZE, g);
        addStaticRect(0, (GRID_HEIGHT - 1) * Tile.TILE_SIZE, GRID_WIDTH * Tile.TILE_SIZE, Tile.TILE_SIZE, g);
        addStaticRect(0, Tile.TILE_SIZE, Tile.TILE_SIZE, (GRID_HEIGHT - 2) * Tile.TILE_SIZE, g);
        addStaticRect((GRID_WIDTH - 1) * Tile.TILE_SIZE, Tile.TILE_SIZE, Tile.TILE_SIZE, (GRID_HEIGHT - 2) * Tile.TILE_SIZE, g);

        for (int x = 2; x < GRID_WIDTH - 2; x += 2) {
            for (int y = 2; y < GRID_HEIGHT - 2; y += 2) {
                addStaticRect(x * Tile.TILE_SIZE, y * Tile.TILE_SIZE, Tile.TILE_SIZE, Tile.TILE_SIZE, g);
            }
        }
    }
